...
IDENTITY="1.0 0.90 0.80 0.70 0.60" # minimum percent identity between query and subject
MIN_LENGTH="1.0 0.90 0.80 0.70 0.60" # minimum percent subject length relative to the query
